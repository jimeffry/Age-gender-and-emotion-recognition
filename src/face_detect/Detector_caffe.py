...
class MTCNNDet(object):
    ...
    def load_model(self):
        ...
        load_ = self.load
        if load_ :
            deploy = '../models/mtcnn_caffe/12net.prototxt'
            caffemodel = '../models/mtcnn_caffe/12net.caffemodel'
        else:
            deploy = '../models/PNet.prototxt'
            caffemodel = '../models/PNet.caffemodel'
        self.net_12 = caffe.Net(deploy,caffemodel,caffe.TEST)
        if load_:
            deploy = '../models/mtcnn_caffe/24net.prototxt'
            caffemodel = '../models/mtcnn_caffe/24net.caffemodel'
        ...
        if load_:
            deploy = '../models/mtcnn_caffe/48net.prototxt'
            caffemodel = '../models/mtcnn_caffe/48net.caffemodel'
    ...
    def detectFace(self,img):
        ...
        if config.onet_out:
            ...
            rectangles = [[0,0,img_w-1,img_h-1]]
