...
def filter_face_48net(cls_prob,roi,pts,rectangles,width,height,threshold):
    ...
    for i in range(len(rectangles)):
        ...
        if x2>x1 and y2>y1 and config.x_y:
            pick.append([x1,y1,x2,y2,rectangles[i][4],rectangles[i][5],rectangles[i][6],rectangles[i][7],rectangles[i][8],rectangles[i][9],\
                                            rectangles[i][10],rectangles[i][11],rectangles[i][12],rectangles[i][13],rectangles[i][14]])
        if x2>x1 and y2>y1 and not config.x_y:
            pick.append([x1,y1,x2,y2,rectangles[i][4],rectangles[i][5],rectangles[i][7],rectangles[i][9],rectangles[i][11],rectangles[i][13],\
                                            rectangles[i][6],rectangles[i][8],rectangles[i][10],rectangles[i][12],rectangles[i][14]])
...
def detect_test(cls_prob,out_side,scale):
    #print("cls and roi",cls_prob.shape,roi.shape)
    in_side = 2*out_side+11
    stride = 3
    if out_side != 1:
